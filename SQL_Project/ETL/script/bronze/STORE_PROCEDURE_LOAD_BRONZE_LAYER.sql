...
BEGIN
	...
	BEGIN TRY 
		...
		FROM 'C:\Users\HP\Downloads\SQL Proqect\Dataset\Hospital+Patient+Records\encounters.csv'
		WITH(
			FIRSTROW=2,
			FIELDTERMINATOR=',',
			TABLOCK
		...
		FROM 'C:\Users\HP\Downloads\SQL Proqect\Dataset\Hospital+Patient+Records\patients.csv'
		WITH(
			FIRSTROW=2,
			FIELDTERMINATOR=',',
			TABLOCK
		...
		FROM 'C:\Users\HP\Downloads\SQL Proqect\Dataset\Hospital+Patient+Records\payers.csv'
		WITH (
			FIRSTROW=2,
			FIELDTERMINATOR=',',
			TABLOCK
		...
		FROM 'C:\Users\HP\Downloads\SQL Proqect\Dataset\Hospital+Patient+Records\procedures.csv'
		WITH(
			FIRSTROW=2,
			FIELDTERMINATOR=',',
			TABLOCK
